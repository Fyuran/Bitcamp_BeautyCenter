...
public class ShiftPanel extends JPanel {
	...
	private void initialize() {
		...
		searchShiftButton.setIcon(new ImageIcon(ShiftPanel.class.getResource("/com/bitcamp/centro/estetico/resources/searchIcon.png")));
		...
		cancelShiftButton.setIcon(new ImageIcon(ShiftPanel.class.getResource("/com/bitcamp/centro/estetico/resources/delete.png")));
		...
		addShift.setIcon(new ImageIcon(ShiftPanel.class.getResource("/com/bitcamp/centro/estetico/resources/Insert.png")));
		...
		editShift.setIcon(new ImageIcon(ShiftPanel.class.getResource("/com/bitcamp/centro/estetico/resources/Update.png")));
		...
		deleteShift.setIcon(new ImageIcon(ShiftPanel.class.getResource("/com/bitcamp/centro/estetico/resources/disable.png")));
		...
		confirmBtn.setBounds(145, 198, 109, 21);
		confirmBtn.setEnabled(false);
		anagraphicPanel.add(confirmBtn);

		cancelBtn = new JButton("Annulla");
		cancelBtn.setBounds(254, 198, 111, 21);
		...
		editShift.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (table.getSelectedRow() != -1) {
					...
					JOptionPane.showMessageDialog(ShiftPanel.this, "Seleziona un turno");
				}
			}
		});
	...
	private void loadEmployees() {
		List<Employee> employeesList = EmployeeDAO.getAllEmployees(); // ----> da sostituire con
	...
	private void fillControls(ShiftEmployee shiftEmployee) {
		...
		else if (type == ShiftType.HOLIDAYS){
	...
	private ShiftEmployee returnNewShiftEmployee() throws Exception {
		...
		Shift shift = new Shift(sdt, edt, shiftType);
