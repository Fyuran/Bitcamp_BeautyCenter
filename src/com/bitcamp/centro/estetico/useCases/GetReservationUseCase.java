...
public class GetReservationUseCase {
	private final ReservationDAO daoReservation; // IDAO?
	private ShiftDAO daoShift;

	List<Employee> busiedEmployees;

	public GetReservationUseCase(ReservationDAO daoReservation, ShiftDAO daoShift) {
		this.daoReservation = daoReservation;
		this.daoShift = daoShift;
	}
	
	public GetReservationUseCase(ReservationDAO daoReservation) {
		this.daoReservation = daoReservation;
	}
